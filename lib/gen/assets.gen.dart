...
class $AssetsMapAnimGen {
  ...
  /// File path: assets/map/anim/spritesheet_enemy_dragonfly.png
  AssetGenImage get spritesheetEnemyDragonfly =>
      const AssetGenImage('assets/map/anim/spritesheet_enemy_dragonfly.png');
...
class $AssetsMapObjectsGen {
  ...
  /// File path: assets/map/objects/tile_gate_lvl5.png
  AssetGenImage get tileGateLvl5Png =>
      const AssetGenImage('assets/map/objects/tile_gate_lvl5.png');
  ...
  /// File path: assets/map/objects/tile_plains_mountains_B.png
  AssetGenImage get tilePlainsMountainsBPng =>
      const AssetGenImage('assets/map/objects/tile_plains_mountains_B.png');

  /// File path: assets/map/objects/tile_plains_mountains_B.tsx
  String get tilePlainsMountainsBTsx =>
  ...
  List<dynamic> get values => [
        ...
        tilePlainsMountainsBPng,
        tilePlainsMountainsBTsx,
...
class $AssetsMapTilesGen {
  ...
  /// File path: assets/map/tiles/tile_atmos_forest_1.png
  AssetGenImage get tileAtmosForest1Png =>
      const AssetGenImage('assets/map/tiles/tile_atmos_forest_1.png');

  /// File path: assets/map/tiles/tile_atmos_forest_1.tsx
  String get tileAtmosForest1Tsx => 'assets/map/tiles/tile_atmos_forest_1.tsx';

  /// File path: assets/map/tiles/tile_atmos_forest_2.png
  AssetGenImage get tileAtmosForest2Png =>
      const AssetGenImage('assets/map/tiles/tile_atmos_forest_2.png');

  /// File path: assets/map/tiles/tile_atmos_forest_2.tsx
  String get tileAtmosForest2Tsx => 'assets/map/tiles/tile_atmos_forest_2.tsx';

  /// File path: assets/map/tiles/tile_atmos_forest_3.png
  AssetGenImage get tileAtmosForest3Png =>
      const AssetGenImage('assets/map/tiles/tile_atmos_forest_3.png');
  ...
  /// File path: assets/map/tiles/tile_forest_bushes_v03.png
  AssetGenImage get tileForestBushesV03Png =>
      const AssetGenImage('assets/map/tiles/tile_forest_bushes_v03.png');

  /// File path: assets/map/tiles/tile_forest_bushes_v03.tsx
  String get tileForestBushesV03Tsx =>
  ...
  /// File path: assets/map/tiles/tile_forest_ground_v03.png
  AssetGenImage get tileForestGroundV03Png =>
      const AssetGenImage('assets/map/tiles/tile_forest_ground_v03.png');

  /// File path: assets/map/tiles/tile_forest_ground_v03.tsx
  String get tileForestGroundV03Tsx =>
      'assets/map/tiles/tile_forest_ground_v03.tsx';

  /// File path: assets/map/tiles/tile_forest_ground_v04.png
  AssetGenImage get tileForestGroundV04Png =>
      const AssetGenImage('assets/map/tiles/tile_forest_ground_v04.png');

  /// File path: assets/map/tiles/tile_forest_ground_v04.tsx
  String get tileForestGroundV04Tsx =>
      'assets/map/tiles/tile_forest_ground_v04.tsx';
  ...
  /// File path: assets/map/tiles/tile_plains_hills_v02.png
  AssetGenImage get tilePlainsHillsV02Png =>
      const AssetGenImage('assets/map/tiles/tile_plains_hills_v02.png');

  /// File path: assets/map/tiles/tile_plains_hills_v02.tsx
  String get tilePlainsHillsV02Tsx =>
  ...
  List<dynamic> get values => [
        ...
        tileForestBushesV03Png,
        tileForestBushesV03Tsx,
        tileForestGroundV02Png,
        tileForestGroundV02Tsx,
        tileForestGroundV03Png,
        tileForestGroundV03Tsx,
        tileForestGroundV04Png,
        tileForestGroundV04Tsx,
        tileGateV2Png,
        tileGateV2Tsx,
        ...
        tilePlainsHillsV02Png,
        tilePlainsHillsV02Tsx,
        tileSkyV02Png,
        tileSkyV02Tsx,
        tileTreehousePng,
        tileTreehouseTsx
