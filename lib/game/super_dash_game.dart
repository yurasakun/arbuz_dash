...
class SuperDashGame extends LeapGame
  ...
  static const _sectionsBackgroundColor = [
    (Color(0xFFad65d0), Color(0xFFad65d0)),
    (Color(0xFF8cebff), Color(0xFF97d019)),
    (Color(0xFF001b70), Color(0xFF2968c4)),
  ];
  ...
  Future<void> onLoad() async {
    ...
    itemsSpritesheet = SpriteSheet(
      image: await images.load('objects/hom.png'),
